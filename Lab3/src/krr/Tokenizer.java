...
public class Tokenizer {
    ...
    private static Tokenizer createExpressionTokenizer()
    {
      ...
      tokenizer.add("->", Token.IF);
      tokenizer.add("<->", Token.IFF);
      tokenizer.add("\\(", Token.OPEN_BRACKET);
      tokenizer.add("\\)", Token.CLOSED_BRACKET);
      tokenizer.add("\\~", Token.NOT);
      tokenizer.add("\\&", Token.AND);
      tokenizer.add("\\|", Token.OR);
      tokenizer.add("#", Token.BOX);
      tokenizer.add("\\*", Token.DIAMOND);

      tokenizer.add("[A-Za-z]+", Token.VARIABLE);
