    ...
    private ExpressionNode affirmOp()
    {
        switch (lookahead.token) {
            ...
            case Token.SUBJECT:
            {
                ...
                hash=Subject.getHash(lookahead.sequence)*100;
                NextToken();
